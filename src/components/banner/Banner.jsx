...
const Banner = () => {
    return (
        <div className='flex items-center justify-between gap-3 h-[400px] bg-gradient-to-r from-[#E0F7F5] to-[#CDEEEE] w-full rounded-lg p-5 pr-0'>
            <div className="">
            ...
            <div className='mx-auto w-fit max-h-fit mb-2 mt-2 pr-0'>
                <LottieComponent
                    animationData={city}
                    loop={true}
